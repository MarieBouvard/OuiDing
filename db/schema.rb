...
ActiveRecord::Schema.define(version: 2021_09_24_122152) do
  ...
  create_table "bookings", force: :cascade do |t|
    ...
    t.index ["categorie_id"], name: "index_bookings_on_categorie_id"
  ...
  add_foreign_key "bookings", "categories", column: "categorie_id"
